import sys
from PySide2.QtWidgets import (QApplication, QWidget, QLabel, QLineEdit, QGridLayout, QPushButton, QHBoxLayout, QVBoxLayout, QMessageBox)
    ...
    def onOk(self):
        if(self.lineEditId.text() not in self.listIds):
            ...
            if self.lineEditPW.text() != self.listPWs[idx]:
                QMessageBox.critical(self,"Logon error","Incorect password")
